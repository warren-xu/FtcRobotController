...
public class HSliderSystem {
   ...
   // public Servo clawRot;
    ...
    private static final double TILT_H_LM = 39; // mechanical limitation
    ...
    public static final int SLIDER_MAX =  1880;   //due to the wire length  calculate (int)(SLIDER_STAGE * SLIDER_STAGE_LEN / (Math.PI * (PULL_WHEEL_DIA + PULLY_WIRE_DIA * 3)) * SLIDER_PPR);  // 2400  2300
    //unit: meter
    ...
    public static final double CLAW_CLOSE_ANGLE = 63;
    ...
    public HSliderSystem(LinearOpMode mainTask, HardwareMap hwMap, Telemetry telemetry, boolean auto)
    {
        ...
        sliderMtr.setPositionPIDFCoefficients(6.0);
    ...
    private static class ResetCascadeThread extends Thread
    {
        public static volatile boolean runningFlag = false;
        public static volatile boolean resetFlag = false;
    ...
    private static class ScanConeThread extends Thread
    {
        public static volatile boolean runningFlag = false;
        public static volatile boolean resetFlag = false;

        private static double leftDis = 2000;
        private static double rightDis = 2000;
        private static final double DETECT_DIS = 150; // 50cm = 0.5m

        private static double scanServoAngle = 0;
        private static boolean foundCone = false;
        ...
        public void run()
        {
            ...
            while(mainTask.opModeIsActive() && runningFlag)
            {
                ...
                rightDis = rightSensor.getDistance(DistanceUnit.MM) - 30; //mm
